...
def relatorio(ini):
    ...
    report_contas_receber_techcd = pandas.read_sql_query(query_contas_receber_techcd, connection, params=params)
    report_contas_receber_data_store = pandas.read_sql_query(query_contas_receber_data_store, connection, params=params)
    report_contas_receber_midia_center = pandas.read_sql_query(query_contas_receber_midia_center, connection,
                                                               params=params)
